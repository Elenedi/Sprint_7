...
public class CourierTest {
    ...
    public void testErrorCreateTheSameCourier() {
        ...
        courierMethods.printResponse(secondResponse, gson); // Вызов метода для второго запроса
    ...
    public void testCreateCourierWithoutPassword() {
        String login = "client" + System.currentTimeMillis();
        String bodyWithoutPassword = "{ \"login\": \"" + login + "\", \"firstName\": \"clipa\" }";
        // Сообщение об ошибке
        String expectedMessage = "Недостаточно данных для создания учетной записи";
        Response response = RestAssured.given()
                .header("Content-Type", "application/json")
