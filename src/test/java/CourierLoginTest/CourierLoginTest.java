...
public class CourierLoginTest {
    ...
    public void tearDown() {
        ...
        if (courierId != -1) {
            courierMethods.deleteCourier(courierId);  // Удаление курьера
        }
    }
    ...
    public void testCourierCanBeCreatedAndLogin() {
        ...
        String loginBody = "{ \"login\": \"client\", \"password\": \"1234\" }";
    ...
    public void testWithWrongLoginOrPasswordCourier() {
        ...
        String bodyWrongCredentials = "{ \"login\": \"wrong\", \"password\": \"1111\" }";
        ...
        String bodyWrongLogin = "{ \"login\": \"wrong\", \"password\": \"1234\" }";
        ...
        String bodyWrongPassword = "{ \"login\": \"client\", \"password\": \"1111\" }"; // Существующий логин
    ...
    // Тест не проходит: при отсутствии поля password
    @Test
